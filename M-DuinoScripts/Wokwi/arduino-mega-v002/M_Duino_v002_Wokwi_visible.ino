/*
  Wokwi-ready wrapper for the M-Duino Trigger Box Controller v002.
...
// Bench-test mode slows this down slightly to make observation easier.
...
void printStartupConfiguration() {
  ...
  Serial.println("================================================");
  Serial.println("Trigger Box Controller v002 startup");
